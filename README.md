...
Sappiamo che una *classe in sè* che esiste nella società non sempre diventa una *classe per sè*, coscente dei suoi interessi e capace di organizzarli in forma di partito. E oggi, tra sinistra di destra e nazionalismi, è sempre più difficile dire chi rappresenta chi. Ci dicono che i poveri sono tutti razzisti (cosa già confutata, si veda per esempio [qui](https://www.theguardian.com/society/2019/mar/05/middle-income-earners-behind-rising-racial-tensions-research-suggests)) e che gli interessi degli imprenditori coincidono con quelli dei salariati. 
